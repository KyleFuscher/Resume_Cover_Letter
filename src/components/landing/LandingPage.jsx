...
const features = [
  {
    ...
    description: 'Generate tailored resumes and cover letters effortlessly with Google\'s Gemini AI, customized for your industry and role.',
  ...
  },
  {
    ...
    description: 'Instantly preview every edit as you build your document—ensuring perfection before you hit ‘Export.',
  ...
  },
  {
    ...
    title: 'Quick Export',
    description: 'Download your resume or cover letter in PDF or Word format—polished and ready for submission anywhere.',
...
const testimonials = [
  {
    ...
    content: 'I landed three interviews within a week of using this builder! The templates are beautiful, and the AI suggestions were spot on.',
      ...
      <div className="relative overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              ...
              >
                ...
                <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Craft job-winning resumes and personalized cover letters in minutes using our AI-powered builder. 
                  Impress recruiters with professional templates and expert guidance.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <motion.img
            ...
            src="https://i.pinimg.com/originals/1d/a9/44/1da944eeeea58e27db560ba9abd1948e.jpg"
